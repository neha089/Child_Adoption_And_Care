...
-- Create Children table next as it references Orphanages and Adopters
...
-- Create Admins table (no FK dependencies)
CREATE TABLE Admins (
...
-- Create ApplicationRecords table which references Adopters, Orphanages, and Children
...
-- Create AdoptionRecords table which references Adopters and Children
...
-- Create HomeStudies table which references Adopters and Children
...
-- Create Donations table which references Orphanages
...
-- Create ChildDocuments table which references Children
...
-- Create AdopterDocuments table which references Adopters
...
-- Create OrphanageDocuments table which references Orphanages
...
-- Create Images table which references Children, Adopters, and Orphanages
CREATE TABLE Images (
