<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdoptionRecord.aspx.cs" Inherits="child_a_c.Crud.AdoptionRecord" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gvAdoptionRecords" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvAdoptionRecords_SelectedIndexChanged">
            <Columns>
        ...
        <asp:Label Text="Adoption ID:" runat="server" />
        ...
        <asp:Label Text="Adoption Date:" runat="server" />
